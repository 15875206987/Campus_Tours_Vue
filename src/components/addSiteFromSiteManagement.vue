      ...
      <Row :gutter="32">
        <Col span="12">
          ...
          <FormItem label="Longitude" label-position="top">
            <Input v-model="formData.site_lng" placeholder="please enter site's longitude"/>
          </FormItem>
        </Col>
        <Col span="12">
          <!--              纬度-->
          <FormItem label="Latitude" label-position="top">
            <Input v-model="formData.site_lat" placeholder="please enter site's latitude"/>
          </FormItem>
        </Col>
      </Row>
...
<script>
  ...
  export default {
    name:"addSiteFromSiteManagement",
    data () {
      return {
        styles: {
